...
class ServerManager {
  ...
  async startServer(id: string) {
    ...
    const proc = spawn('java', [
        ...
        '-XX:CompileCommand=exclude,com/hypixel/hytale/server/core/asset/type/fluid/FluidTicker::isAlive',
        '-XX:CompileCommand=exclude,com/hypixel/hytale/server/worldgen/chunk/populator/PrefabPopulator::isMatchingCover',
        '-XX:CompileCommand=exclude,com/hypixel/hytale/server/core/universe/world/WorldMapTracker::tick',
